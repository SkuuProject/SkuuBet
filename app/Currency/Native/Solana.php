...
class Solana extends Currency {
  ...
  public const DEVNET_ENDPOINT = 'https://api.tatum.io/v3/blockchain/node/solana-devnet';
  ...
  public function newWalletAddress(?\App\Models\User $user = null, ?string $chainId = null): string {
    $randomId = rand();
  ...
  public function request(string $method, array $params = []) {
    // $curl = curl_init(self::MAINNET_ENDPOINT_NO_RATELIMIT);
       $curl = curl_init(self::DEVNET_ENDPOINT);
