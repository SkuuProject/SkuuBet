...
class FiversCan
{
    ...
    {
        return [
            'agentCode' => Settings::get('[FiversCan] Agent Code', 'retr'),
            'agentToken' => Settings::get('[FiversCan] Agent Token', '815da5b05ec8d77f780f2c3725c471d3'),
            'apiUrl' => Settings::get('[FiversCan] API URL', 'https://api.fiverscan.com')
        ];
    }
